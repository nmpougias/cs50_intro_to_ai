...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        # Searching if the key exists in the dictionary, and if so return it.
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        # Initializing reward to keep track of best available reward.
        reward = 0
        
        # Searching for the best reward.
